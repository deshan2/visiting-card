...
export default function ConnectPage() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-screen bg-[#060913] text-gray-200 flex items-center justify-center p-4 overflow-hidden font-sans"
    >
      ...
      <div className="main-card relative max-w-md w-full bg-[#0d1527]/80 backdrop-blur-xl rounded-3xl border border-gray-800/60 p-8 text-center shadow-[0_0_50px_rgba(0,0,0,0.5)] z-10">
        ...
        <div className="space-y-4">
          {/* Portfolio */}
          <a
            href="https://my-newportfolio-five.vercel.app/"
            target="_blank"
            className="social-link group flex items-center justify-between w-full bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold py-3.5 px-6 rounded-2xl transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-400/40 hover:-translate-y-0.5"
          >
          ...
          {/* GitHub */}
          <a
            href="https://github.com/deshan2"
            target="_blank"
            className="social-link group flex items-center justify-between w-full bg-[#111827]/90 hover:bg-[#16223f] border border-gray-800 hover:border-cyan-500/50 text-gray-200 font-medium py-3.5 px-6 rounded-2xl transition-all duration-300 hover:shadow-[0_0_15px_rgba(255,255,255,0.05)] hover:-translate-y-0.5"
          >
            <span className="flex items-center gap-4">
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/sasindu-deshan-39852b2b0/"
            target="_blank"
            className="social-link group flex items-center justify-between w-full bg-[#0a66c2]/10 hover:bg-[#0a66c2]/20 border border-[#0a66c2]/30 text-[#70b5ff] font-medium py-3.5 px-6 rounded-2xl transition-all duration-300 hover:-translate-y-0.5"
          >
            <span className="flex items-center gap-4">
          ...
          {/* WhatsApp */}
          <a
            href="https://wa.me/94741117600"
            target="_blank"
            className="social-link group flex items-center justify-between w-full bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 text-[#4ade80] font-medium py-3.5 px-6 rounded-2xl transition-all duration-300 hover:-translate-y-0.5"
          >
            <span className="flex items-center gap-4">
          ...
          {/* Facebook */}
          <a
            href="https://www.facebook.com/sasindudeshan560/"
            target="_blank"
            className="social-link group flex items-center justify-between w-full bg-[#1877F2]/10 hover:bg-[#1877F2]/20 border border-[#1877F2]/30 text-[#4f9aff] font-medium py-3.5 px-6 rounded-2xl transition-all duration-300 hover:-translate-y-0.5"
          >
            <span className="flex items-center gap-4">
          ...
          {/* Gmail */}
          <a
            href="mailto:sasindudeshan94@gmail.com"
             className="social-link group flex items-center justify-between w-full bg-[#1877F2]/10 hover:bg-[#1877F2]/20 border border-[#1877F2]/30 text-[#4f9aff] font-medium py-3.5 px-6 rounded-2xl transition-all duration-300 hover:-translate-y-0.5"
           >
            <div className="flex items-center gap-4">
              ...
              {/* Text එක */}
              <span className="text-[15px] font-semibold text-slate-200 transition-colors">
                Email Me
              </span>
            </div>

            {/* අනිත් හැම බටන් එකකම තියෙන දකුණු පැත්තේ Arrow Icon (↗) එක */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="w-4 h-4 text-slate-500/80 group-hover:text-slate-400 transition-colors"
            >
